...
class DifftestTop extends Module {
  ...
  // val difftest_ncsr_state = DifftestModule(new DiffNCSRState, dontCare = true)
  val difftest_dasicscsr_state = DifftestModule(new DiffDasicsCSRState, dontCare = true)
